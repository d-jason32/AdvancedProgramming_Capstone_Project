...
/**
 * TranscriptionController handles displaying live audio transcription using SpeechToTextService,
 * managing the transcription lifecycle (start/stop), and initiating the summary
 * generation process upon completion via GeminiService.
 */
